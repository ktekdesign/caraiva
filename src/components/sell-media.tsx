...
const SellMedia = ({social = true}) => (
    <div className="flex justify-center items-center flex-col-reverse sm:flex-row gap-8 mt-4">
        ...
        {social && 
            <div className="flex gap-8 items-center">
                <Link href="https://bit.ly/inforecantodapaz" target="_blank">
                    <Image width={30} height={0} alt="" src="/images/whatsapp.svg" className="hover:scale-125" />
                </Link>
